...
namespace MediatR.Registration
{
    public static class ServiceRegistrar
    {
        public static void AddMediatRClasses(IServiceCollection services, IEnumerable<Assembly> assembliesToScan)
        {
            ...
            var handlerTypes = ConnectImplementationsToTypesClosing(typeof(IRequestHandler<,>), services, assembliesToScan, false);

            services.Configure<MediatREndpointOptions>(x =>
            {
                x.HandlerTypes = handlerTypes;
            });
        ...
        private static List<Type> ConnectImplementationsToTypesClosing(Type openRequestInterface,
