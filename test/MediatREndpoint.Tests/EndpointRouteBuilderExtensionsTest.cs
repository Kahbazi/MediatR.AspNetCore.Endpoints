...
namespace MediatREndpoint.Tests
{
    public class EndpointRouteBuilderExtensionsTest
    {
        ...
        public void WithPathString()
        {
            ...
            services.AddMediatREndpoint(new Type[] { typeof(IRequestHandler<SimpleRequest, Unit>) });
        ...
        public void MultipleRouteRequestAddsMultipleEndpoints()
        {
            ...
            services.AddMediatREndpoint(new Type[] { typeof(IRequestHandler<MultipleRouteRequest, Unit>) });
